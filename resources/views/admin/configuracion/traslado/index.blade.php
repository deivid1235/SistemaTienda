                        ...
                        <tr class="border-b border-slate-100">
                            ...
                            <td class="py-3 px-4">
                                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold
                                    {{ $traslado->descuenta_stock === 'SI' || $traslado->descuenta_stock === 'Si' || $traslado->descuenta_stock === 'Sí' 
                                        ? 'bg-emerald-50 text-emerald-700 ring-1 ring-inset ring-emerald-600/20' 
                                        : 'bg-rose-50 text-rose-700 ring-1 ring-inset ring-rose-600/20' }}">
                                    <span class="w-1.5 h-1.5 rounded-full {{ $traslado->descuenta_stock === 'SI' || $traslado->descuenta_stock === 'Si' || $traslado->descuenta_stock === 'Sí' ? 'bg-emerald-500' : 'bg-rose-500' }}"></span>
                                    {{ $traslado->descuenta_stock }}
                                </span>
                            </td>
                            <td class="py-2">
